(function() {
    ...
    // var note = notes().getNote('a');
    var note = 0;
    oscillator.frequency.value = note;//2500;
    ...
    //     note = notes().getNote('c#', initialValue);
    //     initialValue += diff;
    //     oscillator.frequency.value = note;
    //     if (initialValue === 8) diff = -1;
    //     if (initialValue === 1) diff = 1;
    // }, (60 / bpm) * 1000);

    var start = 0;
    setInterval(function() {
        note = notes().getNote(melody[start], 4);
        oscillator.frequency.value = note;
    ...
    document.addEventListener('keyup', function(e) {
        if (e.keyCode === 32) oscillator.stop();
        console.log('stopped');
    });
